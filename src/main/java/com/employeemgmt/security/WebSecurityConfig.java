...
import com.employeemgmt.serviceimpl.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurityConfig web) throws Exception {

		((WebSecurity) web).ignoring().antMatchers("/h2-console/**");
	}
